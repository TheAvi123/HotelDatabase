...
public class JoinResult extends JPanel {
    private JLabel titleLabel;
    private JButton backButton;
    private JTable table;

    public JoinResult(TableModel model, HotelController controller, JFrame frame) {
        //construct components
        titleLabel = new JLabel ("JOIN QUERY RESULT");
